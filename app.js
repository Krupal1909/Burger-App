...
document.getElementsByClassName('bi-chevron-right')[0].addEventListener('click',()=>{
  ...
  icon_off();
  document.getElementsByClassName('pagi_img')[(index/310)].innerText = images_dt[(index/310)].style.transform = "scale(1.1)"
  document.getElementsByClassName('pagi_img')[(index/310)].innerText = images_dt[(index/310)].style.opacity = 1;
})
...
// let index = 0;
// Array.from(document.getElementsByClassName("main_imgs")).length * 310;
// let images_off = () => {
//   Array.from(document.getElementsByClassName("main_imgs")).forEach(function (
//     element
//   ) {
...
// };
// let icon_off = () => {
//   Array.from(document.getElementsByClassName("pagi_img")).forEach(function (
//     element
//   ) {
...
//   });
// };
// document.getElementsByClassName("bi-chevron-right")[0]
...
//     document.getElementsById('calories').innerText =
//       images_dt[index / 310].calories;
//     document.getElementsById('fat').innerText = images_dt[index / 310].fat;
//     document.getElementsById('protein').innerText =
//       images_dt[index / 310].protein;
//     icon_off();
//     document.getElementsByClassName('pagi_img')[index / 310].style.transform =
//       "scale(1.1)"(document.getElementsByClassName('pagi_img'))[
//         index / 310
//       ].style.opacity = 1;
//   });
// document
